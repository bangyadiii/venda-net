...
@section('content')
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Pelanggan /</span> Edit / #{{ $id }}</h4>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form>
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="basic-icon-default-phone">No Telp/WA</label>
                        <div class="input-group input-group-merge">
                            <span id="basic-icon-default-phone2" class="input-group-text"><i
                                    class="bx bx-phone"></i></span>
                            <input type="text" id="basic-icon-default-phone" class="form-control phone-mask"
                                placeholder="658 799 8941" amia-label="658 799 8941"
