<div>
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Mikrotik /</span> Ubah</h4>
            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Ubah Mikrotik</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <button wire:loading.attr='disabled' type="submit" class="btn btn-primary" x-show="showSaveButton">
